...
def load_data():
    ...
    os.environ["DESTINATION__CREDENTIALS"] = Variable.get("bigquery_credentials")  # env for private key, project id and client email
    ...
    from deployment_demo_pipeline import \
        github_source  # replace with actual script and source names
    
    start_date = Variable.get("start_date", "")
    end_date = Variable.get("end_date", "")

    # Only run this code snippet if I have a start and end date
    ...
    pipeline = dlt.pipeline(pipeline_name='pipeline_name',
                     dataset_name='airflow_github_data_parallel',
